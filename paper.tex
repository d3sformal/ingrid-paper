...
\newcommand{\mpskeyword}[1]{\textcolor{Blue}{\textbf{#1}}}
\newcommand{\mpsalias}[1]{\textcolor{Green}{\textbf{#1}}}
\newcommand{\mpsproperty}[1]{\textcolor{Fuchsia}{\textbf{#1}}}
\newcommand{\mpsplaceholder}[1]{\textcolor{Gray}{\textbf{#1}}}
\newcommand{\mpscardinality}[1]{\textcolor{RoyalBlue}{#1}}
