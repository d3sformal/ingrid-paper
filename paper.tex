...
\bibitem{ref:BaseLanguage} MPS BaseLanguage, \url{https://confluence.jetbrains.com/display/MPSD34/Base+Language}
...
\bibitem{ref:mpsmetabnf} mps-metabnf \url{https://github.com/DSLFoundry/mps-metabnf}
