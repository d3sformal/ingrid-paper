...
\newcommand{\mpsstcardinality}[1]{\textcolor{RoyalBlue}{\textbf{#1}}}
  % MPS editor
\newcommand{\mpsedkeyword}[1]{\textcolor{Black}{\textbf{#1}}}
\newcommand{\mpsedtarget}[1]{\textcolor{RubineRed}{\textbf{#1}}}
\newcommand{\mpsedannotation}[1]{\textcolor{Gray}{\textbf{#1}}}
  % MPS textgen
\newcommand{\mpstgkeyword}[1]{\textcolor{Blue}{\textbf{#1}}}
\newcommand{\mpstgtarget}[1]{\textcolor{RubineRed}{\textbf{#1}}}
\newcommand{\mpstgparam}[1]{\textcolor{RoyalPurple}{\textbf{#1}}}
