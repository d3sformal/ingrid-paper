...
We plan to work on a more automated approach to the definition of Editor aspects in the future, probably using some techniques of machine learning.
...
Figure~\ref{fig:TEXTGENEX} shows a very basic example of BaseLanguage code that can be used as its TextGen aspect.
