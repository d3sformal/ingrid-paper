...
The key idea of this approach is to skip all the intermediary layers (nodes) in the syntax tree and consider just the leaf nodes.
...
We call the leaf nodes as \emph{end nodes} and \emph{end rules}, respectively, because they cannot transparently break into more rules/nodes.
