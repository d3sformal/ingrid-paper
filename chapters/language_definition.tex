...
\PV{Mozna vysvetlit proc (protoze je to dvoji prace) nebo odkazat tam, kde je to vysvetleny?}
...
In order to get a simple representation that is easy to process by the later phases and keeps only information necessary for the construction of MPS languages, several steps of post-processing of the AST have to be performed in this phase.
An output of this phase is a custom AST-like structure representing the grammar.
