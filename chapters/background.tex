...
The symbols \verb|[-| and \verb|-]| represent layout information (cells), which define rules for mutual positioning for the contained cells (vertical, horizontal, indentation).
