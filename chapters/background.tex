...
\todo{Mozna rict jak se zakladni aspekty (Structure, Editor, TextGen) nazyvaji v jinych IDE (Spoofax, apod).}
...
\todo{Check what has been done for Spoofax.}
...
\todo{Najit dalsi podobne systemy (treba Spoofax) a kratce popsat existujici reseni podobnych uloh (automated import of general-purpose languages) v jejich kontextu.}
...
\todo{
Mention other state-of-the-art language workbenches: Spoofax.
	Reference: L.C.L. Kats and E. Visser. The Spoofax Language Workbench: Rules for Declarative Specification of Languages and IDEs. OOPSLA 2010
	Eclipse-based IDE support for SDF-based languages.
	Parser-based language workbench.
		Syntax essentially restricted to linear text.
		But it supports language extension and composition.
}
