...
Using the projectional editor, the user can easily specify information about the code layout, export the target MPS language and in case further adjustments are needed, come back to the grammar definition and fix any problems.
The MPS language of the grammar definition can be easily extended with needed features (indenting, line breaks...), which is superior to our approach.
