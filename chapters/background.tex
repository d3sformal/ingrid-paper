...
In the context of MPS, a \emph{concept} is a language element, i.e. a building block of a language definition.
...
All the ports that we mention below were conducted manually.
...
\textsc{Ingrid} is not applicable for creating languages inside such tools.
